...
1. First, you need to install and run ONOS on your local machine using the instructions that have been posted here: [Developer Quick Start](https://wiki.onosproject.org/display/ONOS/Developer+Quick+Start). 
...
5- After the above steps, you will be able to configure the network using high level abstractions that osdf-reactive application provides. To test the osdf-reactive application, we provide you a set of examples as follows: 
